import { Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, FormControl, FormControlLabel, FormLabel, Grid, InputLabel, Radio, RadioGroup, TextField } from "@mui/material";
import { useState } from "react";
import { useSnackbar } from "../../../../contexts/SnackbarContext";
import { lectureService } from "../../../../services";

const LectureForm = ({ selectedSection, setOpenLectureForm, fetchSectionsAndItsLectures }) => {
  ...
  const handleLectureChange = (e) => {
    ...
    if (type === "file") {
      if (files[0].size > maxSize) {
        showSnackbar({ message: "Video upload maximum size exceeded 1MB", severity: "error" })
        return;
      }
  ...
  return (<>
    <Grid container spacing={1}>
      ...
      <Grid item xs={12}>
        ...
        <Button variant="contained" color="secondary" onClick={() => setOpenDialog(true)} sx={{ marginX: "10px" }}>
          Cancel and return
        </Button>
      </Grid>
