  ...
  return (
    <aside
      className={classNames(
        "transition-width fixed left-0 top-0 z-20 flex h-full w-64 flex-shrink-0 flex-col pt-16 duration-200 lg:flex ",
        {
          "lg:w-64": open,
          "lg:w-16": !open,
        },
    ...
    >
      <div className="relative flex min-h-0 flex-1 flex-col bg-gray-50 pt-0">
        <div className="flex flex-1 flex-col overflow-hidden overflow-y-auto pb-4 pt-8">
          <div className={classNames("flex-1 bg-gray-50", { "px-3": open })}>
              ...
              {sidebarOptions.map((opt, idx) => (
                <li key={idx} className="my-1">
                  <Link
                    to={opt.href}
                    className={classNames(
                      "text-dark-500 group flex items-center rounded-lg py-2 text-base font-normal transition-all duration-200 hover:bg-gray-200",
                      {
                  ...
                  >
                    <div
                      title={t(opt.key)}
                      className={classNames(
                        "text-dark-700 mr-1 grid place-items-center rounded-lg p-2 text-center text-gray-800 shadow-lg shadow-gray-300 dark:text-white",
                        {
                    ...
                    <span className="text-dark-500 ml-8 text-sm font-light">
                      {t(opt.key)}
                    </span>
                  </Link>
                </li>
        ...
        <div
          className={classNames(
            "relative bottom-0 left-0 hidden w-full items-center justify-center space-y-2 bg-gray-100 lg:flex",
            {
              "flex-col py-4": !open,
              "space-x-4 p-4": open,
            },
        ...
        >
          ...
          <a
            title="Settings"
            className="hover:text-dark-500 inline-flex cursor-pointer justify-center rounded text-gray-500 hover:bg-gray-200"
          >
            <SettingsIcon />
          </a>
